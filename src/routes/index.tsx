...
import { Moon, Sun, ShieldAlert, Zap, Radio, Fuel, Gauge, Clock, ShieldCheck, Thermometer, Wind } from "lucide-react";
...
function Overview() {
  ...
  return (
    <>
      ...
      {isHimadri && (
        <div className="mb-5 rounded-xl border border-sky-500/30 bg-sky-950/20 p-4 text-xs leading-relaxed text-sky-200 backdrop-blur shadow-sm">
          <div className="flex items-center gap-2 font-semibold uppercase tracking-wider text-sky-400">
